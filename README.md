...
Proficient in HTML, CSS(SASS/SCSS), and JavaScript for Web Development, along with practical knowledge of frameworks and libraries such as React(React Query, Redux, Router), Bootstrap, jQuery, Tailwind CSS. I also have a solid foundation in Java, C/C++, Python, PHP, and SQL. Currently, I am expanding my expertise through professional seminars on TypeScript and on Python libraries.
